export const portfolio = {
  ...
  person: {
    ...
    languages: [
      { name: 'Portuguese', level: 'Native', namePt: 'Portugues', levelPt: 'Nativo' },
      { name: 'English', level: 'C2 proficient', namePt: 'Ingles', levelPt: 'C2 fluente' },
    ],
  },
  positioning: {
  ...
  aiSystems: [
    {
      name: 'Arbitus',
      stack: ['Rust', 'MCP', 'Security'],
      url: 'https://github.com/arbitusgateway/arbitus',
    ...
    },
    {
      ...
      stack: ['Java/Android', 'Python', 'Bash'],
  ...
  projects: [
    ...
    },
    {
      ...
      href: '/matecreations',
      github: 'https://github.com/mateCreations',
      logo: '/mate-logo.png',
      tags: ['Design System', 'CSS', 'TypeScript'],
    },
    {
      name: 'keybinds-tui',
  ...
  skills: [
    { group: 'Languages', groupPt: 'Linguagens', items: ['Java', 'TypeScript', 'Python', 'Rust', 'Go'] },
    { group: 'Backend', groupPt: 'Back-end', items: ['Spring Boot', 'Node.js', 'Keycloak', 'Kong API Gateway', 'REST', 'Kafka'] },
    { group: 'Frontend', groupPt: 'Front-end', items: ['Vue.js', 'React'] },
    { group: 'Data & Infra', groupPt: 'Dados & Infra', items: ['PostgreSQL', 'MySQL', 'Redis', 'Docker', 'Kubernetes', 'GitLab CI', 'AWS', 'GCP'] },
    { group: 'Observability', groupPt: 'Observabilidade', items: ['Grafana', 'Loki', 'New Relic', 'Sentry', 'OpenTelemetry'] },
    { group: 'Telecom', groupPt: 'Telecom', items: ['FTTH/ONU provisioning', 'RADIUS/PPPoE', 'OSS/BSS workflows', 'service assurance', 'WFM/field service'] },
    { group: 'Architecture', groupPt: 'Arquitetura', items: ['Microservices', 'DDD', 'Hexagonal', 'Event-Driven', 'zero-downtime migrations'] },
  ],
  writing: [
    {
    ...
    { title: 'Auditing a PII exposure across a Java microservice stack', href: '/posts/pii-exposure-audit', summary: 'Production security write-up.' },
    { title: 'MCP gateway', href: '/posts/mcp-gateway', summary: 'Design argument behind Arbitus.' },
    { title: 'JDBC migration', href: '/posts/jdbc-migration', summary: 'Engineering write-up from production migration work.' },
  ],
};

export const siteUrl = portfolio.meta.site;
