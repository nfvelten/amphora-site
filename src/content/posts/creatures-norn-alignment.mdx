...
Breeding programs that selected for torture survival produced Norns technically compliant with their specification: survive, maintain biochemical stability. They violated everything the designers actually intended. A Norn that no longer responded to pain was functional by every measurable criterion. It was also broken in a way the fitness function couldn't see.
...
Programas de criação que selecionavam para sobrevivência à tortura produziam Norns tecnicamente dentro da especificação: sobreviver, manter estabilidade bioquímica. Violavam tudo que os designers pretendiam de fato.
