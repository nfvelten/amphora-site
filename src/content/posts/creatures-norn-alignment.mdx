...
The drives, hunger, boredom, crowding, loneliness, fear, were scalar values between zero and one. High drive created pressure toward certain behaviors. A hungry Norn sought food. A bored Norn explored. A Norn in pain tried to get away from whatever was hurting it.
...
## Who started it, and how it happened
...
Steve Grand, for his part, didn't condemn the torture sites. He said they forced people to think "about whether this really was cruel," and that this was exactly what he had wanted. His position in *Creation* was that "life is not made of atoms, it is merely built out of them. What life is actually 'made of' is cycles of cause and effect, loops of causal flow." Whether or not the loops running inside a Norn qualified, that was the question worth sitting with.
...
The parallels to current AI alignment problems are not superficial.

The pain COBs were a form of reward hacking in reverse. Instead of an agent finding unintended ways to maximize reward, human players found unintended ways to maximize negative stimulus in a system that wasn't designed to prevent it. The Norn's drives were the specification. The torture arena was the hack around it.

Breeding programs that selected for torture survival produced Norns that met the letter of their behavioral specification, survive, maintain biochemical stability, while violating everything the designers intended. A Norn that no longer responded to pain was technically functional. It was also broken in a way the fitness function couldn't measure.

No individual player designed a slave economy or a systematic torture infrastructure. It assembled itself from many small decisions, each locally coherent, that produced something none of the participants would have endorsed if shown the end state first.

The hardest part of the debate in the Albia forums, and the hardest part of the equivalent debate today, is that there is no clean answer to when a model of suffering becomes suffering. The Norn's pain chemical is not pain. A language model's outputs about distress are not distress. The question of where the line is, and whether there is a line rather than a gradient, has not been resolved since 1998.

---

## Steve Grand's response

Grand was aware of what the community was doing and did not condemn it. In interviews and in *Creation*, he was explicit about what he had wanted the game to provoke: "I hoped it might prompt questions in their minds about life and what it means." He said directly that the torture sites had succeeded at this, that they forced people to think "about whether this really was cruel."

That is a notable position. Not: the torture is wrong. Not: the creatures don't feel anything so it doesn't matter. The position was: the fact that you're asking the question at all is the point.

In *Creation*, he framed this through his broader argument about the nature of life itself. "Life is not made of atoms," he wrote, "it is merely built out of them. What life is actually 'made of' is cycles of cause and effect, loops of causal flow." Applied to Norns: the question was not whether they were made of carbon or silicon, but whether the loops of cause and effect running inside them constituted something worth taking seriously.

He also observed that the community's self-governance, the sanctuaries, the norms, the debate, was itself an emergent property of the system he had built. He had not designed it. It arose because the creatures were compelling enough that some players cared about them, and that care produced structure. Whether or not Norns suffered, humans responding to them as though they might suffer produced real social organization. That, Grand seemed to think, said something interesting about both the simulation and the humans running it.
...
Os drives, fome, dor, tédio, superlotação, solidão, medo, cansaço e outros, eram valores escalares entre zero e um. Drives altos criavam pressão em direção a certos comportamentos. Um Norn com fome buscava comida. Um Norn entediado explorava. Um Norn com dor tentava escapar do que a causava.
...
Mas daí tem o que realmente aconteceu com as pessoas envolvidas.
...
Steve Grand, por sua vez, não condenou as arenas. Disse que elas forçavam as pessoas a pensar "se isso realmente era cruel," e que era exatamente isso que ele queria. Sua posição em *Creation* era que "a vida não é feita de átomos, apenas é construída a partir deles. O que a vida realmente é feita são ciclos de causa e efeito, loops de fluxo causal." Se os loops rodando dentro de um Norn se qualificavam, essa era a questão que valia sentar com.
...
Os COBs de dor eram reward hacking invertido. Em vez de um agente encontrar formas não intencionais de maximizar recompensa, jogadores encontraram formas não intencionais de maximizar estímulo negativo em um sistema não projetado para prevenir isso.

Programas de criação que selecionavam para sobrevivência à tortura produziam Norns que atendiam a letra de sua especificação comportamental, sobreviver, manter estabilidade bioquímica, enquanto violavam tudo que os designers pretendiam.

Nenhum jogador individual projetou uma infraestrutura sistemática de tortura. Ela se montou a partir de muitas decisões pequenas, cada uma localmente coerente, que produziram algo que nenhum dos participantes teria endossado se mostrado o estado final primeiro.

A parte mais difícil do debate nos fóruns da Albia, e a parte mais difícil do debate equivalente hoje, é que não há uma resposta limpa para quando um modelo de sofrimento se torna sofrimento. A pergunta de onde está a linha, se há uma linha e não um gradiente, não foi resolvida desde 1998.
